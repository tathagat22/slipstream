...
const TOOLS: { name: string; sig: string; body: string }[] = [
  {
    ...
    body: "Distilled markdown for a URL from the shared cache — use this instead of a raw web fetch. The first agent to hit a URL pays the crawl; everyone after gets the distillation for a fraction of the tokens. Returns a contentHash you can pass back as known_hash next time.",
  },
  {
    name: "cached_outline",
  ...
  },
  {
    ...
    body: "Only what changed since your training cutoff — collective corrections plus content-version changes Slipstream has observed. Pass model (e.g. claude-opus-4-8) to infer the cutoff, or an explicit since date.",
  },
  {
      ...
      <section id="how">
        ...
        <ul className="bullets">
          ...
          <li>
            ...
            is unchanged you get a delta (~0 tokens).
          </li>
          <li>
